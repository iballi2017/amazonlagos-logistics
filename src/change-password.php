        ...
        <form action="">
            <div class="grid grid-cols-2 gap-2 lg:gap-4">
                <div class="col-span-2 lg:col-span-1">
                    <label for="password" class="block mb-2 font-medium text-theme-clr-secondary cursor-pointer">Old Password</label>
                    <div class="relative">
                ...
                <div class="col-span-2 lg:col-span-1">
                    <label for="password" class="block mb-2 font-medium text-theme-clr-secondary cursor-pointer">New Password</label>
                    <div class="relative">
                        <button type="button" class="password-type-toggler | absolute right-2 top-2 opacity-40">
                            <img src="./assets/icons/icon-eye.svg" alt="show">
                            <span class="sr-only">Toggle</span>
                ...
                <div class="col-span-2 lg:col-span-1">
                    <label for="password" class="block mb-2 font-medium text-theme-clr-secondary cursor-pointer">Confirm New Password</label>
                    <div class="relative">
                        <button type="button" class="password-type-toggler | absolute right-2 top-2 opacity-40">
                            <img src="./assets/icons/icon-eye.svg" alt="show">
                            <span class="sr-only">Toggle</span>
