    ...
    <div class="main-container text-center text-theme-clr-secondary py-8">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2 lg:col-span-1 flex items-center justify-center flex-col gap-y-4 p-6 bg-white rounded-lg shadow">
                ...
                <a href="./jumbo-pack-buy-and-ship-order-summary.php" class="bg-theme-clr-primary hover:bg-theme-clr-secondary hover:text-white py-2.5 px-8 rounded-md">Select</a>
            </div>

            <div class="col-span-2 lg:col-span-1 flex items-center justify-center flex-col gap-y-4 p-6 bg-white rounded-lg shadow">
                <img src="./assets/images/jumbo-pack-buy-ship.png" alt="">
                <h5 class="mb-2 text-2xl font-bold tracking-tight">Ship only</h5>
                <a href="./ship-only-order-summary.php" class="bg-theme-clr-primary hover:bg-theme-clr-secondary hover:text-white py-2.5 px-8 rounded-md">Select</a>
            </div>
